            ...
            <div class="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <!-- ---------- Filter Form ---------- -->
                            <form method="GET" action="{{ route('customerreportsearch') }}" class="row g-3 p-4">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <label for="customer_name">All Customers</label>
                                    <select class="form-select" name="customer_name">
                                    <option value="">Select</option>
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->customer_name }}"
                                        {{ request('customer_name') == $customer->customer_name ? 'selected' : '' }}>
                            ...
                            <h1 class="mx-3">Customer Report</h1>
                                ...
                                <div class="table-responsive">
                                    <table class="styled-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th style="text-align:left;width:680px;">Customer</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($customerData as $data)
                                                ...
                                                <tr>
                                                    <td>{{ $counter++ }}</td>
                                                    <td style="text-align:left">{{ $data['customer']->customer_name }}</td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (pdfBtn) {
            pdfBtn.addEventListener('click', function () {
                ...
                heading.innerText = 'Customer Report';
