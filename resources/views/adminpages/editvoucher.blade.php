                      ...
                      <div class="row">
                        ...
                        <div class="table-responsive mt-3">
                          <table class="table table-bordered" id="productTable">
                            <thead>
                                <tr>
                                    <th style="background-color: #1a2035; color: white;width:400px">Account</th>
...
function selectAccount(element, id, name) {
  ...
  const selectedLabel = wrapper.querySelector(".selected-account");
  const hiddenInput = wrapper.querySelector(".selectedAccountId");
