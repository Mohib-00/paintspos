                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" id="dealname" name="deal_name">
                      ...
                      <div class="col-md-12 col-lg-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" id="dealprice" name="deal_price">
                          <span id="nameError" class="text-danger"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        ...
                        <table class="table table-bordered" id="productTable">
                          ...
                          <tbody id="tableBody">
                            <tr>
                                  ...
                                  <ul class="dropdown-menu custom-dropdown-menu" style="display:none; position:absolute; top:100%; left:0; width:100%; max-height:300px; overflow-y:auto; z-index:1050; background:#fff; border:1px solid #ccc; box-shadow:0 2px 8px rgba(0,0,0,0.15);">
                                    ...
                                    @foreach($products as $product)
                                      <li class="product-item">
                                        <a class="dropdown-item" href="#" onclick="selectProduct(this, '{{ $product->id }}'); return false;">{{ $product->item_name }}</a>
                                      </li>
                                      <li><hr class="dropdown-divider"/></li>
                                    @endforeach
                                  </ul>
                              ...
                              <td style="display: none"><input type="number" name="single_purchase_rate[]" style="display:none" class="form-control single_purchase_rate" readonly></td>
                              <td style="display: none"><input type="number" name="single_retail_rate[]" style="display:none" class="form-control single_retail_rate" readonly></td>
    ...
    function selectProduct(el, id) {
      ...
      $.ajax({
        ...
        success(data) {
          ...
          dropdown.querySelector('.selectedProductId').value = id;
          ...
          row.querySelector('.purchase_rate').value = (data.single_purchase_rate * qty).toFixed(2);
          row.querySelector('.retail_rate').value = (data.single_retail_rate * qty).toFixed(2);
