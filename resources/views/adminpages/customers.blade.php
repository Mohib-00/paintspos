                            ...
                            <tbody>
                                ...
                                @foreach($customers as $customer)
                                        <tr class="user-row" id="customer-{{ $customer->id }}">
                                            ...
                                            <td>{{$customer->id}}</td>
                                            <td>
                                                <img height="80" width="80" src="{{ asset('images/' . $customer->img) }}" alt="Customer Image" 
                                                style="cursor: pointer;" onclick="openImageModal('{{ asset('images/' . $customer->img) }}')">
                                            </td>


                                        <div id="imageModal" style="display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%;
                                            background-color: rgba(0,0,0,0.8); text-align: center;">
                                            <span onclick="closeImageModal()" 
                                            style="position: absolute; top: 20px; right: 35px; color: white; font-size: 40px; font-weight: bold; cursor: pointer;">&times;</span>
                                            <img id="modalImage" style="margin-top: 5%; max-width: 90%; max-height: 80%; border-radius: 10px; box-shadow: 0 0 15px #fff;" />
                                            <br><br>
                                            <a id="downloadLink" href="#" download
                                            style="margin-top: 20px; padding: 12px 25px; background-color: #4CAF50; color: white; border: none;
                                            border-radius: 8px; font-size: 16px; text-decoration: none; font-weight: 600; box-shadow: 0 4px 10px rgba(0,0,0,0.2); transition: 0.3s ease;">
                                            ⬇ Download Image
                                            </a>
                                        </div>
               ...
               if (response.success) {
                removeLoader();
                   Swal.fire({
                       ...
                       customer.find('td:eq(3) img').attr('src', "{{ asset('images') }}/" + customer.image);
                       customer.find('td:nth-child(4)').text(response.customer.customer_name);
                       ...
                       customer.find('td:nth-child(9)').text(response.customer.client_fixed_discount); 
